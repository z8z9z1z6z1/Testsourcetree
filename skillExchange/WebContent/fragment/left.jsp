			...
			<div class="sb-sidenav-menu">
				<div class="nav">
					...
					<div class="collapse.in" id="collapseLayouts"
						...
						<a class="nav-link" href="${jspPath}/queryskillClass.do?name=才藝">才藝</a> 
						<a class="nav-link" href="${jspPath}/queryskillClass.do?name=運動">運動</a> 
						<a class="nav-link" href="${jspPath}/queryskillClass.do?name=語言">語言</a> 
						<a class="nav-link" href="${jspPath}/queryskillClass.do?name=寵物">寵物</a> 
						<a class="nav-link" href="${jspPath}/queryskillClass.do?name=生活">生活</a>							
					</div>
