					...
					<form action="${pageContext.request.contextPath}/publishPage.Controller/publishPage" method="POST" enctype="application/x-www-form-urlencoded">
        				...
        				<fieldset>
            				...
            				<div class="st1">
                				...
                				<input type='text' name='publishTitle' value="${param.publishTitle}">
            				...
            				<div class="st1">
								...
								<img id = "prePic" src="#" width="200px" name='prePic' value="${param.publishPic}"/><br>
            				</div>
  							
  							<div class="st1">
  								<label for="" class="l1">刊登內容:</label>
  								<textarea cols="40" row="5"  name='publishDetail' value='${param.publishDetail}'></textarea>
...
<!-- 									<option id="E" vlaue="HUA">花蓮</option> -->
  							...
  							<div class="st1">
  								...
  								<input type='text' name='district' value='${param.district}'><hr>
  								<label for="" class="l1">路名:</label>
  								<input type='text' name='road' value='${param.road}'>  
  							</div>
  							
  							<div class="st1">
  								<label for="" class="l1">希望地點:</label>
  								<input type='text' name='publishPlace' value='${param.publishPlace}'><hr>
        				...
        				<fieldset>
            				<legend>備註</legend>
  							<div class="st1">
  								...
  								<textarea cols="40" row="5"  name='publishMark' value='${param.publishMark}'></textarea> 
  							</div>
        				</fieldset>
