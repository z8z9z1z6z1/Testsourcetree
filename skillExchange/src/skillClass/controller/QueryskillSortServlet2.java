...
@WebServlet("/queryskillClasssort.do")

public class QueryskillSortServlet2 extends HttpServlet {
	...
	private List<Publish> skillQuery(String skillType) {
		String hql = "from Publish P join fetch P.member WHERE P.skillType = :skillType order by publishCTR DESC";
